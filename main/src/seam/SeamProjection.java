...
public final class SeamProjection{
    ...
    public Rect hostBounds(SeamRuntime runtime, Rect out){
        ...
        Vec2 a = runtimeWorldToHost(0f, 0f, new Vec2());
        Vec2 b = runtimeWorldToHost(width, 0f, new Vec2());
        Vec2 c = runtimeWorldToHost(width, height, new Vec2());
        Vec2 d = runtimeWorldToHost(0f, height, new Vec2());
